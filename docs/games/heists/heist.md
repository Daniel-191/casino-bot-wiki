...
Only **one heist per channel** can be active at a time, and a heist can't be hosted in a channel that already has another multiplayer game running in it. If a heist stalls, the channel frees itself automatically. You can't host or join a heist if you're already in one (multiplayer or solo).
...
| **Paradise Vault** | 2–15 | 82% | 3.35× | Patreon Exclusive |
...
|---|---|---|
| All locations except Paradise Vault | 4 | 2–3, rising with crew size |
| **Paradise Vault** | 5 | 3 |

The Paradise Vault runs a longer job, and its failure allowance stays at 3 no matter how big the crew is - bringing more people raises your payout, not your safety net.
