...
On success: payout = `entry_fee × (1.20 to 1.40 random multiplier)`, minus tax on the winnings only (your entry fee is never taxed), so a successful heist is always a net profit.
